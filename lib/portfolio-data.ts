...
export const experience = [
  ...
  },
  {
    ...
    current: false,
    highlights: [
      '自社ECサイトの機能開発・運用保守とリアーキテクチャを担当、Go + GraphQL の PoC を経て Next.js 化を主導し 2024.07 リリース',
      '研究開発部門向け社内DXシステムをアーキテクトとして設計・レビュー、業務委託エンジニアをマネジメント',
      '「作らない開発」とトイル撲滅、スクラム導入とチームビルディングで開発者体験を改善',
    ],
  },
  {
    ...
    current: false,
    highlights: [
      'モバイルオーダーのリプレースで DDD 戦略的設計を主導、輪読会・ドメインモデリング・モブプロを通じてGo経験者を3名に増やしMVP達成',
      'Feasibility Study の上で Amazon Cognito を採用し会員管理システムを約3ヶ月でリリース(社内初のGoサービス)',
      '技術的負債の大きい既存コードのリファクタリングとテストカバレッジ計測・ADR導入で品質と意思決定を可視化、新メンバーの立ち上がりを1sprint化',
    ],
  },
  {
